...
- All views are accessible via unique URL segments (e.g.: <https://cards.skorboard.app/:sqid/rivalries>,
...
- SQIDs should be 6 characters and case-insensitive.
- SQIDs should use a seeded alphabet.
